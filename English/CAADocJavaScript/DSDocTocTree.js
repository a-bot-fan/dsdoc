...
//    show = args2["show"];
  ...
  */
  ...
  } else { // Do not run selectCurrentFile with Firefox and home pages.
	//////////////////////////////////////////////////////////////////////////////
...
// Added VLE1 accept to have href value as the result of a js function
    var ii = nodeInfo.link.indexOf('javascript:');
    if (ii == -1)
      itemLink.href = nodeInfo.link;
    else {
      try{
        itemLink.href = eval(nodeInfo.link.substring(ii+11));
        }
      catch(e){
        console.log(e);
        }
